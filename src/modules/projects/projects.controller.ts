...
export class ProjectsController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Create a new project with key and standard workflow seed',
  })
  @ApiResponse({
    status: 201,
    description: 'Project successfully initialized with workflow.',
  })
  ...
  @Get(':idOrKey')
  @ApiOperation({
    summary: 'Retrieve project by Key or ID, including workflow structure',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Board columns and issues retrieved.',
  })
  @ApiResponse({ status: 404, description: 'Project not found.' })
